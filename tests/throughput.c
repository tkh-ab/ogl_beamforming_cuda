...
main(i32 argc, char *argv[])
{
	...
	if (options.remaining_count != 1){
		stream_append_str8(&path, str8_from_c_str("C:\\Users\\tkhen\\OneDrive\\Documents\\MATLAB\\lab\\ultrasound_matlab\\vrs_data\\flow\\april_26_flow\\260429_CSX4002B_dfluid_static_9mhz_FORCES-Tx-Row.bp"));
	}
	else{
